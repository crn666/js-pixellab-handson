...
console.warn(`
Calculeaza suprafata de tapet necesara pentru o camera de 6 pe 4 m cu
tavan inalt de 2.5m, stiind ca exista o usa de 2.2 pe 1.5 si
...
a-i aduce imbunatatiri, extra cod sau pentru a-i limita in mod intentionat capacitatile.
`);
